...
figure
plot(w(:,1),w(:,3),'b-',xeq,zeq,'c.',-xeq,zeq,'c.',w(1,1),w(1,3),'r.',...
    'MarkerSize',24,'LineWidth',2)
xlabel('x','FontSize',24)
ylabel('z','FontSize',24)
title('Lorenz Attractor','FontSize',24)

figure
plot3(w(:,1),w(:,3),w(:,2),'b-',w(1,1),w(1,3),w(1,2),'r.', ...
    xeq,zeq,yeq,'c.',-xeq,zeq,-yeq,'c.','MarkerSize',24,'LineWidth',2)
grid on
xlabel('x','FontSize',24)
ylabel('z','FontSize',24)
